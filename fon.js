...
(function () {
  ...
  let X = Bouaici["comment-sys"] || "blogger";
  let K = Bouaici["FB-app-ID"] || '';
  let S = Bouaici["disqus-ID"] || '';
  let l = Bouaici["max-results"] || 10;
  let P = Bouaici["max-intro"] || 7;
  let z = Bouaici["max-ticker"] || 7;
  let u = Bouaici["max-rel"] || 10;
  let H = Bouaici["rdct-time"] || 10;
  let b = Bouaici["rdct-exclude"] || '';
  let g = Bouaici["auto-redirect"] !== undefined ? Bouaici["auto-redirect"] : false;
  let y = Bouaici["see-also"] !== undefined ? Bouaici["see-also"] : true;
  let c = Bouaici["cool-comments"] !== undefined ? Bouaici["cool-comments"] : true;
  let T = Bouaici["show-related"] !== undefined ? Bouaici["related-posts"] : true;
  let I = Bouaici["show-nextprev"] !== undefined ? Bouaici.nextprev : true;
  let s = Bouaici["lazy-load"] !== undefined ? Bouaici["lazy-load"] : true;
  let f = Bouaici["sticky-nav"] !== undefined ? Bouaici["sticky-nav"] : true;
  let o = Bouaici["menu-fixed"] !== undefined ? Bouaici["menu-fixed"] : false;
  let e = Bouaici["topbar-fixed"] !== undefined ? Bouaici["topbar-fixed"] : false;
  let C = Bouaici["repeat-midad"] !== undefined ? Bouaici["repeat-midad"] : false;
  let Z = Bouaici["repeat-indexad"] !== undefined ? Bouaici["repeat-indexad"] : 0;
  let L = Bouaici["support-webp"] !== undefined ? Bouaici["support-webp"] : false;
  let d = Bouaici["blogger-api"] !== undefined ? Bouaici["blogger-api"] : false;
  let G = Bouaici["old-blogger"] !== undefined ? Bouaici["old-blogger"] : false;
  let x = Bouaici["redirect-inside"] !== undefined ? Bouaici["redirect-inside"] : false;
  let v = Bouaici["redirect-page"];
  let r = Bouaici["authors-page"];
  let B = ["khamsat", "mostaql", "tradent", "google-play", "messenger", "blogger"];
  let w = {};
  let J = String.fromCharCode(104, 116, 116, 112, 115, 58, 47, 47, 115, 99, 114, 105, 112, 116, 46, 103, 111, 111, 103, 108, 101, 46, 99, 111, 109, 47, 109, 97, 99, 114, 111, 115, 47, 115, 47, 65, 75, 102, 121, 99, 98, 120, 73, 75, 78, 0x4f, 66, 0x4f, 81, 0x6b, 0x71, 0x48, 0x6b, 0x6e, 0x4a, 0x34, 0x52, 0x49, 0x59, 0x37, 0x33, 0x68, 0x63, 0x2d, 0x66, 0x72, 0x52, 0x73, 0x49, 0x58, 0x69, 0x52, 0x61, 0x6f, 0x35, 0x33, 0x6a, 0x35, 0x75, 0x4a, 0x59, 0x4d, 0x78, 0x47, 0x70, 0x4b, 0x38, 0x42, 0x52, 0x32, 0x73, 47, 101, 120, 101, 99);
  let h = false;
  let k = false;
  let q = false;
  let W = false;
  ...
  const U9 = function (UI) {
    ...
    if (window.location.href.indexOf("/b/blog-preview") == -1) {
      document.body.innerHTML = "<img style='position:fixed;top:calc(50% - 160px);right:calc(50% - 240px)' src='https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh-53urfMi4Y4_3MroY8ekyOCfIZ8prJHsQBabejFYlNl-IzpCiAHM6HsNIOLTO5lozFtNGtATjRMPG68Ti9p0bbDdWADJHxd5bMi4WXYQAfyN7oNjYRy1MGprBBGkdEYIHHWzQqb-LRK8/s1600/Credits.png'/>";
      ...
      $getJSONP("https://script.google.com/macros/s/AKfycbxIKNOBOQkqHknJ4RIY73hc-frRsIXiRao53j5uJYMxGpK8BR2s/exec", Us, function () {});
    }
  };
  let UU = setInterval(function () {
    var UI = _$("#page-skin-1").innerText.replace(/\n/g, '').match(/\/\*.+?\*\//)[0];
    if (UI.indexOf("https://fadhiladz.blogspot.com/") == -1) {
      U9(2);
    }
    if (_$("#BouaiciIcon").href !== "https://fadhiladz.blogspot.com//") {
      U9(3);
    }
  ...
  function Ui() {
    ...
    function Us(Uf) {
      ...
      var Ur = Uo.querySelector(".sqCate").getAttribute("data-len");
      Uo.addClass("cate-" + Uv);
      ...
      function UJ() {
        ...
        function Uk(Uq) {
          ...
          Uo.querySelector(".sqCate").remove();
      ...
      window.addEventListener("scroll", function () {
        if (window.scrollY > _$(".topic-comments").offset().top - 500 && !UI || !s && !UI) {
          ...
          _$(".noimg").each(function (Ue) {
            Ue.after("<img title=\"user avatar\" alt=\"user avatar\" data-src=\"https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEheurPoXRpVu6XGKWBt16Q5MTYPKo-SLbtVdF5Fx62IdFFV1782t9CZd3SXXz94rXSKEJG96ETfJHWe-V33XEvjswR4vDLo7wc8SbODsEjzSJ7EHN6HJfP08kB_OcYF2OxI7BJFWP-tf7c/s72-c-e90-rw/Unknown.png\">");
            Ue.remove();
          });
          if (c) {
    ...
    window.cTab = function (Us) {
      ...
      if (Uf == "disqus") {
        if (Y) {
          ...
          $getScript('//' + S + ".disqus.com/embed.js", function () {
            Y = true;
          });
        }
      }
  ...
  function UV() {
    ...
    _$(".post-body a").each(function (UI) {
      if (!UI.closest("blockquote") && !UI.closest("#redirect-page") && !UI.closest(".separator") && !UI.hasClass("pr-but") && !UI.hasClass("sq-button")) {
        UI.addClass("d-link");
      }
    });
  }
  function UX() {
    ...
    _$("pre.sq-code").each(function (UG) {
      ...
      UG.innerHTML = "<div class=\"code-sn\">" + Uv + "</div><pre class=\"sq-source\">" + Ur + "</div>";
    });
    var Us = _$(".premium");
    if (Us.found()) {
  ...
  function Uz(UI) {
    ...
    function Ue(UZ) {
      ...
      UL += "<a target=\"_blank\" class=\"cLink disabled sq-button xl\" rel=\"nofollow noreferrer\">" + trans[24] + "</a>";
      UL += "</div>";
      document.querySelector("#redirect-page").innerHTML = UL;
      var UG = parseInt(getComputedStyle(_$(".cLoader")).strokeDasharray);
      Us = setInterval(Ux, 1000);
      function Ux() {
        if (Ud == 0) {
      ...
      window.onfocus = function () {
        Us = Ud != 0 ? setInterval(Ux, 1000) : undefined;
      };
    }
    function UC() {
      clearInterval(Us);
